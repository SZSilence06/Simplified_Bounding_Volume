...
namespace SBV
{
    ...
    private:
        struct EdgeInfo
        {
            ...
            Point position;        //the position to collapse to
    ...
    private:
        ...
        double computeError(size_t vert, const Point& point);
        bool isCollapseable(size_t firstVert, size_t secondVert);
        bool isValidCollapse(size_t firstVert, size_t secondVert, const Point &collapseTo);
        void collapseEdge(size_t firstVert, size_t secondVert, const Point &collapseTo);
        ...
        void buildOneRingArea(size_t firstVert, size_t secondVert, std::vector<Eigen::Vector2i>& lines,
        ...
        bool findCollapsePos(size_t vert, size_t vertCollapseTo, Point& position, double& out_error);
