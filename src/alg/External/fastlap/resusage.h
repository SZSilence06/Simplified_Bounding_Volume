...
#define OTHER			/*  */
#define starttimer	clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &start)	/*  */
#define stoptimer   clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &end); dtime = (end.tv_sec - start.tv_sec) * 1e3 + (end.tv_nsec - start.tv_nsec) * 1.0 / 1e6  	/*  */
#define DUMPRSS			/*  */
