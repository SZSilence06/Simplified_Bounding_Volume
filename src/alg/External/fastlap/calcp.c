...
int jtflag, calcflag;
 ...
 int num2nd=0, num4th=0, numexact=0;
 int num2ndsav=0, num4thsav=0, numexactsav=0;
...
int order;
{
  /* These are the temporary spherical harmonic coefficient matrices
   ...
   double **Mmn, **Mrmn, **Mtmn, **Mrtmn;
  /* These are the temporary spherical harmonic coefficient matrices
     containing both the dipole terms. */
   double **Nmn, **Nrmn, **Ntmn, **Nrtmn;
   double **Pmn, **Binom;
   double *Fact;
...
eulerAngles(X, Y, Z, pcosa, psina, pcosb, psignb, pcosg, psing)
